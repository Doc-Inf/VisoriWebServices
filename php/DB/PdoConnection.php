<?php
    class PdoConnection implements DB{
        ...
        public function getConnection(){
            try {
                if($this->con==null){
                    $this->con = new PDO($this->dbmsName . ":host=" . $this->hostname . ";dbname=" . $this->dbname . ";charset=utf8mb4",$this->username, $this->password,[PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC]);
                }                
